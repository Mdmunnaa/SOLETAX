    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nino', models.CharField(blank=True, help_text='Required before any HMRC MTD submission can be made.', max_length=9, validators=[django.core.validators.RegexValidator(message='Enter a valid National Insurance number (e.g. AB123456C), no spaces.', regex='^[A-CEGHJ-PR-TW-Z]{1}[A-CEGHJ-NPR-TW-Z]{1}[0-9]{6}[A-D]{1}$')], verbose_name='National Insurance number')),
                ('utr', models.CharField(blank=True, help_text='10-digit UTR from your Self Assessment registration.', max_length=10, validators=[django.core.validators.RegexValidator(message='Enter a valid 10-digit Unique Taxpayer Reference (UTR).', regex='^\\d{10}$')], verbose_name='Unique Taxpayer Reference')),
                ('business_id', models.CharField(blank=True, help_text="Returned by HMRC after registering a self-employment income source. Empty until the user has linked their HMRC account via OAuth.", max_length=50, verbose_name='HMRC Business ID')),
